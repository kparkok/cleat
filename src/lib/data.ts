...
export const communityPosts: CommunityPost[] = [
  {
    ...
    likedByMe: false,
    comments: [
      { id: "c-sp-1", authorName: `@${currentMember.username}`, initials: currentMember.initials, authorIsMe: true, body: "I have one — I'm on Dock G. Stop by or reply here.", timeAgo: "1h ago" },
      { id: "c-sp-2", authorName: "Sam W.", initials: "SW", body: "Got one too if Rosa's tied up.", timeAgo: "45m ago" },
    ],
    timeAgo: "2h ago",
    date: "Jul 24",
  },
  {
    ...
    likedByMe: false,
    comments: [
      { id: "c-fc-1", authorName: `@${currentMember.username}`, initials: currentMember.initials, authorIsMe: true, body: "Yes — they switched to 24/7 card readers last spring. Chip or tap.", timeAgo: "2h ago" },
    ],
    timeAgo: "3h ago",
    date: "Jul 24",
  },
  {
    ...
    likedByMe: false,
    comments: [
      { id: "c-ss-1", authorName: "Jordan M.", initials: "JM", body: "Still there as of noon — gave it a wide berth. Thanks for the heads up!", timeAgo: "5d ago" },
    ],
    timeAgo: "6d ago",
    date: "Jul 18",
  },
  {
    ...
    likedByMe: false,
    comments: [
      { id: "c-pp-1", authorName: "Jordan M.", initials: "JM", body: "Yep, been flaky for weeks. Logged it with the office Monday.", timeAgo: "2w ago" },
      { id: "c-pp-2", authorName: "Dave K.", initials: "DK", body: "Marina emailed — it's on the maintenance list for this week.", timeAgo: "1w ago" },
    ],
    timeAgo: "2w ago",
    date: "Jul 9",
  },
  {
    ...
    likedByMe: false,
    comments: [
      { id: "c-rr-1", authorName: "Sam W.", initials: "SW", body: "Pacific Rigging on Shilshole Ave — ask for Dave. Done our boat twice, really thorough.", timeAgo: "7w ago" },
    ],
    timeAgo: "7w ago",
    date: "Jun 2",
  },
  {
    ...
    likedByMe: false,
    comments: [
      { id: "c-ff-1", authorName: "Alex R.", initials: "AR", body: "Card works right up to close. After-hours it's chip-only at the pump.", timeAgo: "4d ago" },
    ],
    timeAgo: "4d ago",
    date: "Jul 20",
  },
